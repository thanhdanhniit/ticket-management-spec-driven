...
public class EscalationPolicySeeder implements CommandLineRunner {
     ...
     * Step 2 — If unacknowledged after 15 min, escalate to the Backend Platform team.
    ...
    private void seedPolicy1() {
        ...
        stepRepository.saveAll(List.of(
                EscalationStep.builder()
                        ...
                        .stepOrder(1)
                        .waitTimeMinutes(0)
                        .targetId(UUID.fromString("00000000-0000-0000-0000-000000000001")) // placeholder: primary on-call user
                ...
                EscalationStep.builder()
                        ...
                        .stepOrder(2)
                        .waitTimeMinutes(15)
                        .targetId(UUID.fromString("00000000-0000-0000-0000-000000000010")) // placeholder: Backend Platform team
                ...
                EscalationStep.builder()
                        ...
                        .stepOrder(3)
                        .waitTimeMinutes(30)
                        .targetId(UUID.fromString("00000000-0000-0000-0000-000000000011")) // placeholder: SRE team
                        .targetType(EscalationStep.TargetType.TEAM)
                        .build()
        ));
    ...
    private void seedPolicy2() {
        ...
        stepRepository.saveAll(List.of(
                ...
                EscalationStep.builder()
                        ...
                        .stepOrder(2)
                        .waitTimeMinutes(10)
                        .targetId(UUID.fromString("00000000-0000-0000-0000-000000000001")) // placeholder: admin user
                        .targetType(EscalationStep.TargetType.USER)
                        .build()
        ));
